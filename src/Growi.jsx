...
const TX={
  es:{
    ...
    hero_p:"Encuentra productores agrícolas verificados en campo. Tú eliges, yo te conecto personalmente con el productor. Sin intermediarios.",
    ...
    steps:[{n:"01",t:"Explora el directorio",d:"Busca por cultivo, región o temporada. Toda la información de producción y precios directos del rancho son visibles."},{n:"02",t:"Solicita una conexión",d:"¿Te interesa un productor? Solicita la conexión por $5,000 MXN. Me dices qué necesitas, cuánto volumen, y para cuándo."},{n:"03",t:"Yo hago la introducción",d:"Contacto personalmente al productor, le presento tu interés, y facilito la conexión directa entre ustedes."}],
  ...
  en:{
    ...
    hero_p:"Find field-verified agricultural producers. You choose, I personally connect you with the producer. No middlemen.",
