...
const TX = {
  es: {
    ...
    hero_p: "Datos y precios de productores reales que no encontrar\u00e1s en internet. Verificados en persona, actualizados por temporada. Suscr\u00edbete al directorio o solicita una b\u00fasqueda personalizada.",
  ...
  en: {
    ...
    hero_p: "Real producer data and pricing you won't find online. Verified in person, updated by season. Subscribe to the directory or request a custom search.",
